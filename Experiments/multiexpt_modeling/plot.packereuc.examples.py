...
prob_spaces = {
    'Target Influence': PackerEuc(cats,pos),
    'Contrast Influence': PackerEuc(cats,neg),
    'Combination': PackerEuc(cats,pos_neg)
}
...
fname = 'packereuc-examples'
f.savefig('packereuc-examples.pdf', bbox_inches='tight', transparent=True)
